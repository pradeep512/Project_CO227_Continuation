...
//   const [passwordError, setPasswordError] = useState("");
//   const [formErrors, setFormErrors] = useState(false);
//   const [showPopup, setShowPopup] = useState(false); // For popup message
...
//     setPasswordError("");
//     setFormErrors(false);
//     setShowPopup(false); // Hide popup when resubmitting
...
//           setPopupMessage("Incorrect username or password. Please try again.");
//           setShowPopup(true);
//         } else {
//           setPopupMessage("There was an error with the login. Please try again later.");
//           setShowPopup(true);
//         }
//       });
//   };
