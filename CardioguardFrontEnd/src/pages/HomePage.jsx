...
export default function HomePage() {
  ...
  const scrollToBlog1 = () => {
    if (topicRef.current) { // Scroll to the heading instead of blog1Ref
  ...
  return (
    <div>
      ...
      <div className="my-8"> {/* Adds margin between the graph and blogs */}
        <BarGraph />
      </div>
      {/* Add the ref to the heading */}
      <h1 ref={topicRef} className="text-5xl mb-4 text-center font-bold text-orange-500">
        Let's Talk About Heart Health
      </h1>

      <div className="shadow-lg p-6 rounded-lg mb-8"> {/* Shadow and spacing */}
        <Blog1 />
      </div>
