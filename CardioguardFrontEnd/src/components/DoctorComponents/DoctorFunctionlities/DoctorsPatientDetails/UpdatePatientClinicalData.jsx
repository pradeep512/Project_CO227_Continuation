...
const PatientClinicalDataUpdate = ({ patientId, clinicalDataId, onClose }) => {
  ...
  useEffect(() => {
    const fetchClinicalData = async () => {
      try {
        ...
        setError("Error fetching clinical data.");
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setError("There was an error with the update.");
    }
  };
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="cursor-pointer"
              />
              <label className="text-gray-700">Diagnosis of Heart Disease</label>
            </div>
            ...
            {/* Creatinine Phosphokinase */}
            <div className="mb-4">
              <label className="block text-gray-700">Creatinine Phosphokinase</label>
              <input
                type="number"
                name="creatininePhosphokinase"
                value={formData.creatininePhosphokinase}
            ...
            {/* Ejection Fraction */}
            <div className="mb-4">
              <label className="block text-gray-700">Ejection Fraction (%)</label>
              <input
                type="number"
                name="ejectionFraction"
                value={formData.ejectionFraction}
            ...
            {/* Follow-Up Period */}
            <div className="mb-4">
              <label className="block text-gray-700">Follow-Up Period (Days)</label>
              <input
                type="number"
                name="followUpPeriodDays"
                value={formData.followUpPeriodDays}
